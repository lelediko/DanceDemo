...
<body>
 <div class="users">
	...
	<div align="center">
		<form method="post">
			<input type="text" name="u" placeholder="昵称" required="required" /><br>
			<input type="text" name="p" placeholder="年龄" required="required" /><br>
			<input type="text" name="p" placeholder="性别" required="required" /><br>
			<input type="text" name="p" placeholder="邮箱" required="required" /><br>
			<input type="text" name="p" placeholder="舞种" required="required" /><br>
			<input type="text" name="p" placeholder="舞龄" required="required" /><br>
			<input type="text" name="p" placeholder="所属舞团" required="required" /><br>
			<input type="text" name="p" placeholder="舞团职位" required="required" /><br>
